...
def test_2_states_classification(Ds=[0.0, 0.08], num_tracks=1000):
    ...
    predictions = [
        bayes_filter.predict_states(track, max_lag=4, smooth=0) for track in tracks
    ]
    ...
    print(
        f"bound fraction sim: {n_bound/total:.1%}, \
...
def test_2_states_classification_smooth(Ds=[0.0, 0.08], num_tracks=1000):
    ...
    predictions = [
        bayes_filter.predict_states(track, max_lag=4, smooth=1) for track in tracks
    ]
